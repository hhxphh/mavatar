...
def render_sets(model, net, opt, epoch:int):
    #print('model.train_stage33',model.train_stage)
    evaluator = Evaluator()
    ...
    with torch.no_grad():
        ...
        #test_dataset = avatarmodel.train_dataset
        ...
        for idx, batch_data in enumerate(tqdm(test_loader, desc="Rendering progress")):
            ...
            image, = avatarmodel.render_free_stage(batch_data, 59400,model.train_stage)
...
if __name__ == "__main__":
    ...
    #print('model.train_stage11',model.train_stage)
    ...
    #print('model.train_stage22',model.train_stage)
    render_sets(model.extract(args), network.extract(args), op.extract(args), args.epoch,)
    #print('model.train_stage44',model.train_stage)
    ...
    def train_stage(self, batch_data, iteration,stage):
        ...
        if stage == 2 or stage == 3:
            ...
            if self.use_inp==1:
                ...
                #print(pose_featmap.shape,'stage3')
        ...
        if stage == 3:
            geo_loss = torch.mean(self.geo_feature**2)
            #pose_loss = torch.mean(pose_featmap ** 2)
            return torch.stack(rendered_images, dim=0), full_pred, offset_loss, geo_loss,  gs_loss,scale_loss,#pose_loss
        return

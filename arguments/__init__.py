...
oula_arm_l = transforms.euler_angles_to_matrix(torch.tensor([[-90.0, 0.0, 0.0]], dtype=torch.float32) / 180 * np.pi, 'XYZ')
...
class ModelParams(ParamGroup): 
    def __init__(self, parser, sentinel=False):
        #self.take_list = ['take2', 'take3', 'take4', 'take5']
        #self.take_list = ['take2', 'take3', 'take4', 'take5', 'take6', 'take8', 'take9']
        self.take_list = ['take2']
        self._source_path = ""
        self._model_path = ""
        ...
        self.smpl_gender = 'female'    # neutral, female, male, neutral as defaults
        self.smpl_type = 'smplx'    #  'smplx' 'smpl'
